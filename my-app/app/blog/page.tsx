...
const PageBlog = () => {
  ...
  return (
    <>
       ...
       <Header />
      <div className="bg-background text-white py-56 px-8">
        <motion.div className="max-w-7xl mx-auto text-center mb-10">
         
          <motion.p className="text-center">
           Domine o mercado financeiro: Informações que dão a sua
            empresa a vantagem competitiva que ela precisa
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <motion.a
              ...
              className="inline-block text-white font-semibold py-2 hover:text-[#CCAA76]"
            >
              Continuar lendo
            </motion.a>
          </motion.div>
